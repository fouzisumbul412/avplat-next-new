          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full text-xl px-4 py-3 bg-white text-slate-900 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#1868A5] focus:outline-none"
            ...
            <div>
              ...
              <textarea
                ...
                rows={2}
                className="w-full px-4 py-2 bg-white text-slate-900 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#1868A5] resize-none focus:outline-none"
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-white text-slate-900 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#1868A5] focus:outline-none"
