        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden">
          <tr>
            <td style="background:#111;padding:30px;text-align:center;color:#fff;">
              <h1 style="margin:0;font-size:28px;letter-spacing:2px;">AvPlat AVIATION</h1>
          ...
          <tr>
            <td style="padding:40px">
              ...
              <p style="color:#444;line-height:1.6;font-size:15px;">
                Thank you for contacting AvPlat Aero. Our aviation concierge team has received your request and will contact you shortly.
              </p>
              ...
              <table cellpadding="0" cellspacing="0" style="margin-top:25px">
                <tr>
                  <td style="background:#000;border-radius:4px">
                    <a href="mailto:info@AvPlat.aero" style="display:inline-block;padding:12px 22px;color:#fff;text-decoration:none;font-size:14px;letter-spacing:1px;">CONTACT CONCIERGE</a>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="background:#f5f5f5;padding:25px;text-align:center;font-size:12px;color:#666">
              <p style="margin:0 0 8px">AvPlat Aviation Concierge</p>
              <p style="margin:0">concierge@AvPlat.aero</p>
              <p style="margin:12px 0 0;color:#aaa;font-size:11px">© ${new Date().getFullYear()} AvPlat Aviation. All rights reserved.</p>
            </td>
          </tr>
        </table>
      </td>
