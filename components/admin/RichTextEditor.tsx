...
export default function RichTextEditor({ content, onChange }: { content: string, onChange: (html: string) => void }) {
  ...
  return (
    <div className={
      isFullscreen 
        ? "fixed inset-0 z-[9999] text-slate-900 bg-white flex flex-col w-screen h-screen overflow-hidden" 
        : "border border-slate-300 text-slate-900 rounded-lg bg-white overflow-hidden focus-within:ring-2 focus-within:ring-[#1868A5] transition-all"
    }>
